...
| REST API                  | Hono HTTP adapter: create/read/vread/update(+create-on-update)/delete, ETag/Location/versioning, OperationOutcome errors (history + search endpoints next)              | ✅ Built (MVP) ([ADR 0005](docs/adr/0005-hono-http.md))             |
